...
- **70+ bosses** and 700+ items, with drop rates and values sourced from real OSRS data (not guessed). Boss-only by design, no filler monsters that just drop bones
